...
void loadDic(const HMMModel* model) 
{
   	model_ = model;
 isNeedDestroy_ = false;
  ...
  void Cut(Unicode::const_iterator begin, Unicode::const_iterator end, std::vector<Unicode>& res) const {
 ...
 private:
  ...
  void InternalCut(Unicode::const_iterator begin, Unicode::const_iterator end, std::vector<Unicode>& res) const {
