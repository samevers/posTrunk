...
static int s_iconv(string &src, string &result,string in,string out)
{
...
int _utf16_to_utf8(string &src, string &result)
{
	return s_iconv(src,result,"utf-16","UTF8");
}
int _utf8_to_utf16(string &src, string &result)
{
	return s_iconv(src,result,"UTF8","utf-16");
}
int _utf16_to_gbk(string &src, string &result)
{
	return s_iconv(src,result,"utf-16","GB18030");
}
int _gbk_to_utf16(string &src, string &result)
{
	return s_iconv(src,result,"GB18030","utf-16");
}

int _gbk_to_utf16le(string &src, string &result)
{
	return s_iconv(src,result,"GB18030","utf-16le");
}


int _utf8_to_gbk(string &src, string &result)
{
	return s_iconv(src,result,"UTF8","GB18030");
}
int _gbk_to_utf8(string &src, string &result)
{
	return s_iconv(src,result,"GB18030","UTF8");
}

/*
string trim_left(string &s,string &drop=" ")
{
...
*/
//处理gbk的截长问题
string cut_strLen(string &src,int len){
	unsigned char tmp;
	int realLen=0;
...
int strtoks(const char *src,const char *sep,std::vector<string> &ret){
	ret.clear();
...
string  str_find(string &src,int ibeg,string begtag,string endtag,int &ifind)
{
...
uint64_t hex2uint64(string hexStr)
{
		uint64_t ret;
        char *offset;
        if (hexStr.length() > 2){
