...
INCLUDES = -I/usr/include -I$(CURRENTPATH) -I$(CURRENTPATH)/QueryOptimizer/modules/queryintent/src/thirdparty/protobuf/src 
INCLUDES += -I$(CURRENTPATH)/QueryOptimizer
INCLUDES += -I$(CURRENTPATH)/QueryOptimizer/modules/common
